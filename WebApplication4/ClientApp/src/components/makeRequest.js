    ...
    makeRequest.prototype.showClientBuildingInfo = function () {
        ...
        return (React.createElement("div", null, this.props.ClientBuildingInfo.map(function (d, index) {
            return React.createElement("div", null,
                React.createElement(Accordion_1.CustomAccordion, { key: index, title: "Location " + (index + 1), content: React.createElement("div", null,
...
;
exports.default = (0, react_redux_1.connect)(function (state) { return state.ClientBuildingInfo; }, ClientBuildingInfoStore.actionCreators)(makeRequest);
