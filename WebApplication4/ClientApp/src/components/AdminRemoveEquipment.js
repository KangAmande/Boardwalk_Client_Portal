...
// This is admin side view for seeing requests of remove equipment by client.
...
exports["default"] = react_redux_1.connect(function (state) { return state.RemoveEquipments; }, RemoveEquipmentsStore.actionCreators)(AdminRemoveEquipment);
