...
function (_super) {
  ...
  makeRequest.prototype.render = function () {
    ...
    while (i < 3) {
      a.push(React.createElement("div", null, React.createElement(Accordion_1.CustomAccordion, {
        title: "Location " + i.toString(),
        content: React.createElement("div", null, React.createElement("p", null, "Building Type"), React.createElement("p", null, "Primary Operation"), React.createElement("p", null, "Street"), React.createElement("p", null, "City"), React.createElement("p", null, "Postal Code"))
    ...
    return React.createElement(React.Fragment, null, React.createElement("div", {
      ...
      type: 'submit',
      value: 'submit'
    })), React.createElement("br", null), React.createElement("br", null), a, this.props.ClientBuildingInfo.map(function (pol) {
      return React.createElement("p", {
        key: pol.Id
      }, pol.street, pol.City, pol.PostalCode, pol.PrimaryOperation);
    }))));
  };
