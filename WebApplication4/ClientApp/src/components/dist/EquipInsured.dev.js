...
function (_super) {
  ...
  EquipInsured.prototype.render = function () {
    return React.createElement(React.Fragment, null, React.createElement("div", {
      ...
      className: 'col-4'
    }, React.createElement(InfoBar_1["default"], null)), React.createElement("div", {
      className: 'col-8'
    }, React.createElement("h1", null, "List of Equipments insured under commercial policy"), React.createElement("br", null), React.createElement("div", null, this.showEquipments()))));
  };
...
}, EquipmentsStore.actionCreators)(EquipInsured);