...
var MailAddr_1 = require("./MailAddr"); // require("custom.css");
...
exports["default"] = function () {
  return React.createElement("div", null, React.createElement(Layout_1["default"], null, React.createElement(react_router_1.Route, {
    path: '/',
    component: PolicyMenu_1["default"]
  }), React.createElement(react_router_1.Route, {
    path: '/sign-docs',
    component: SignDocs_1["default"]
  }), React.createElement(react_router_1.Route, {
    path: '/pink-slips',
    component: PinkSlips_1["default"]
  }), React.createElement(react_router_1.Route, {
    path: '/cert-insur',
    component: CertInsur_1["default"]
  }), React.createElement(react_router_1.Route, {
    path: '/invoices',
    component: Invoices_1["default"]
  }), React.createElement(react_router_1.Route, {
    path: '/policy-limits',
    component: PolicyLimits_1["default"]
  }), React.createElement(react_router_1.Route, {
    path: '/vehicle-insured',
    component: VehicleInsured_1["default"]
  }), React.createElement(react_router_1.Route, {
    path: '/driver-insured',
    component: DriverInsured_1["default"]
  }), React.createElement(react_router_1.Route, {
    path: '/equip-insured',
    component: EquipInsured_1["default"]
  }), React.createElement(react_router_1.Route, {
    path: '/risk-addr',
    component: RiskAddr_1["default"]
  }), React.createElement(react_router_1.Route, {
    path: '/mail-addr',
    component: MailAddr_1["default"]
  }), React.createElement(react_router_1.Route, {
    path: '/make-request',
    component: makeRequest_1["default"]
  }), React.createElement(react_router_1.Route, {
    path: '/sched-equip',
    component: scheduledEquipments_1["default"]
  }), React.createElement(react_router_1.Route, {
    path: '/sched-call',
    component: scheduleCall_1["default"]
  }), React.createElement(react_router_1.Route, {
    path: '/under-review',
    component: underReview_1["default"]
  })));
};