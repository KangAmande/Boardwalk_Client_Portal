...
import helpPageRoute from './Routes/helpPageRoute';
import accountRoute from './Routes/accountRoute';
import cpRoute from './Routes/cpRoute';
...
export default () => (
    <div>
      <BrowserRouter>     
                ...
                <Route path='/help-page' component={helpPageRoute} />
                <Route path='/account' component={accountRoute} />
                <Route path='/ChangePassword' component={cpRoute} />
         </BrowserRouter>
    </div>
);
